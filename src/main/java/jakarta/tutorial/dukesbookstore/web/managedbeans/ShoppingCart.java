...
/**
 * <p>
 * Backing bean used by the <code>/bookcatalog.xhtml</code>,
 * <code>/bookshowcart.xhtml</code>, and <code>/bookcashier.xhtml</code> pages.
 * </p>
 */
@Named("cart")
@SessionScoped
public class ShoppingCart extends AbstractBean implements Serializable {
	...
	public synchronized double getTotal() {
		double amount = 0.0;
		for (ShoppingCartItem item : getItems()) {
			BookDTO bookDetails = (BookDTO) item.getItem();
	...
	public HashMap<String, ShoppingCartItem> retrieveItemMap() {
		return this.items;
	}
}
