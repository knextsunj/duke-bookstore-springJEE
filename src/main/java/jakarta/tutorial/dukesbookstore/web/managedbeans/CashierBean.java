...
import jakarta.tutorial.dukesbookstore.dto.assembler.ShoppingCartDTOAssembler;
...
//    BookRequestBean bookRequestBean;
    ...
    public String submit() throws OrderException {
        ...
        if ((cart.getTotal() > 100.00) && !specialOffer.isRendered()) {
        	...
        	ShoppingCartDTOAssembler shoppingCartDTOAssembler = new ShoppingCartDTOAssembler();
        	

				bookService.updateInventory(shoppingCartDTOAssembler.buildShoppingCartDTO(cart));
